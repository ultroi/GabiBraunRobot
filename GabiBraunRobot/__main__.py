...
PM_START_TEXT = """
`Hey There!` [🙋](https://telegra.ph/file/74c9e96d7a1b9075efaa5.jpg) `My name is` *L Lawliet*
`I am an Anime Themed group management bot.
Build  in partnership and' *Owner is Chika [@Siilentqueen] and managed by Ryuk [@Weeb_lover]* `for Your Telegram Group , I specialize in managing anime and similar themed groups.
